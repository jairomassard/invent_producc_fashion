...
export default {
  ...
  methods: {
    ...
    descargarPlantilla() {
      const csvData = [
        ["nota_credito", "codigo", "nombre", "cantidad", "bodega", "fecha_devolucion"],
        ["NC001", "GRA05299901000000", "R5 BULK PASTEL YELLOW", "50", "Bodega1", "2025-03-01 10:00:00"],
        ["NC002", "GRA05299909000000", "R5 BULK PASTEL LIGTH PINK", "75", "Bodega2", "2025-03-01 10:30:00"],
      ];
      const csvContent =
    ...
    exportarDetalleExcel() {
      ...
      const worksheetData = [
        ...
        [], // Línea en blanco
        ["Código", "Nombre", "Cantidad Devuelta", "Bodega"],
      ];
