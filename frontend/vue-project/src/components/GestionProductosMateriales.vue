      ...
      <section class="carga-csv">
        ...
        <div v-if="mostrarModal" class="modal-instructivo">
            <div class="modal-contenido">
                ...
                <p>3️⃣ **Peso Total / Unidad**: Obligatorio solo para productos a granel.</p>
                <p>4️⃣ **Código de Barras**: Código de barras opcional.</p>
                <p>5️⃣ **Es Producto Compuesto**: "Sí" si el producto es compuesto, "No" si es a granel.</p>
                <p>6️⃣ **Cantidad Productos**: Si el producto es a granel, se coloca 0. Si es compuesto, indicar cuántos productos lo conforman.</p>
  ...
  export default {
    ...
    methods: {
        ...
        async cargarProductosDisponibles() {
            try {
                const response = await apiClient.get('/api/productos', { params: { limit: 500 } }); // Limitar carga
      ...
      descargarPlantillaCSV() {
        ...
        const csvContent = 
            ...
            `# Si el porducto es a granel, se coloca cero 0. Si el producto es compuesto, indicar cuántos productos base lo conforman.\n` +
            ...
            `GRA12345678901234,Ejemplo Producto Granel,500,50,1234567890123,No,0,,,,\n` +
    ...
    mounted() {
        ...
        this.cargarProductosDisponibles();  // Cargar productos en el selector
    },
